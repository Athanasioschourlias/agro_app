...
class MenuActivity : AppCompatActivity() {
    ...
    fun createFieldPerimeter(view: android.view.View) {
        startActivity(Intent(this, CreatePolygonActivity::class.java).putExtra("apikey",apiKey).putExtra("email", email))
    }

    fun fieldsData(view: android.view.View) {
        startActivity(Intent(this, FieldData::class.java).putExtra("apikey",apiKey).putExtra("email", email))
    }
